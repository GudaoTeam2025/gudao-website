(() => {
  ...
  const topics = {
    ...
    water:{label:'WATER',title:'水',intro:'給水方式: 繞盆給水、腰水泡盆、其他，建立好的根系才能進行精養控水',points:[['01','先看介質','確認介質與養護環境的乾燥速度'],['02','再看環境','光、風、溫度與濕度變化後，原本的給水週期可能需要調整'],['03','最後看植株','新葉、葉片硬度、根系狀況與近期生長，可提供更多判斷線索']],note:'澆水後需避免長時間積水；腰水或泡盆培育請評估環境合適再進行'}
  };

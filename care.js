(() => {
  ...
  const topics = {
    light:{label:'LIGHT',title:'光',intro:'光照不過度追求馬上強光，真正重要的是植株階段需求的光量、每天照射時間建議12-16小時搭配定時器',points:[['01','光照強度','光譜數據各植物燈品牌不同，建議詢問店家確認'],['02','每日照射時間','高強度短時間與低強度長時間都可嘗試，但仍要觀察植株表現'],['03','成長階段','芽苗、小苗、中株與成株的耐受及調整速度不同，換環境時要逐步增加光照強度或時長']],note:'若提高光照，請同步觀察葉片表現，避免植株出現異狀'},
    wind:{label:'AIRFLOW',title:'風',intro:'風不只是降溫，也是在室內環境中協助帶走熱與降低染菌風險，維持穩定空氣交換',points:[['01','帶走熱','協助降低葉片與燈具附近的熱停滯'],['02','協助蒸散','空氣流動會影響葉面與介質周圍的水分交換'],['03','減少悶濕','降低葉心、盆面及植株間長時間潮濕染菌的機會']],note:'風扇加入或是風量提高後，介質可能更快乾燥；請觀察盆重與介質狀態，靈活調整給水節奏'},
    water:{label:'WATER',title:'水',intro:'給水方式 : 繞盆給水、腰水泡盆，等其他給水方式，建議有好的根系再進行精養控水',points:[['01','先看介質','確認介質與養護環境的乾燥速度'],['02','再看環境','光、風、溫度與濕度變化後，評估適合自己環境的給水頻率(幾天給一次水)'],['03','最後看植株','新葉、葉片硬度、根系狀況與近期生長，可提供更多判斷線索']],note:'澆水後需避免長時間積水；腰水或泡盆培育請評估環境合適再進行'}
  };
  ...
  const symptoms = {
    ...
    '葉片發紅':{causes:['光環境突然改變','光照突然過強','根系、養分或過熱等環境壓力'],checks:['目前光強度過強，赤紅素保護機制','回顧燈距、時數與近期調整','檢查根系環境與介質排水']},
    ...
    '長期外出養護建議':{causes:['提前延長給水','降低光照強度','調整光照時數'],checks:['外出前一個月延長給水頻率','光照強度減少或是時數減少','環境許可提前調整腰水','務必先進行調整觀察確保植株狀態']}
  };

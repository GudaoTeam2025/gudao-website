(() => {
  ...
  const topics = {
    light: {
      ...
      points: [
        ['01', '光照強度', '燈具瓦數不同品牌強度不同；距離、角度、都會改變結果'],
        ['02', '每日照射時間', '高強度短時間與低強度長時間都可以，但還是要觀察植株表現，建議照射12-16小時'],

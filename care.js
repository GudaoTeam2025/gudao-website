(() => {
  ...
  const stages = {
    seedling: { label:'小苗', title:'苗芽期：先建立穩定根系', copy:'光量逐步建立，同時保持適度空氣流動；根系與介質尚在建立\n光照建議：PPFD 約 100 或 LUX 5,000–30,000', light:'低至中', wind:'穩定通風', water:'小量觀察', target:{light:38,wind:45,water:40} },
    ...
    medium: { label:'小亞成', title:'小亞成株：穩定養護，追求型態', copy:'植株根系逐漸完整，可逐步提高環境強度，但仍需依植株適應狀況調整；光提高時，通風與給水也要同步觀察\n光照建議：PPFD 約 800 或 LUX 50,000–100,000', light:'中至偏高', wind:'穩定通風', water:'依乾燥調整', target:{light:65,wind:62,water:50} },
